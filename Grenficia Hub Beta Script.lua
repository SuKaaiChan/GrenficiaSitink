...
local Window = redzlib:MakeWindow({
  Title = "Grenficia Hub :  Premium Script",
  SubTitle = "by wintrdude",
  SaveFolder = "Grenficia Hub | Blox Fruits Script Premium"
})
...
Discord:AddDiscordInvite({
  Name = "Grenficia Hub | Community",
  Description = "Join our discord community to receive information about the next update",
  Logo = "https://placeit-img-1-p.cdn.aws.placeit.net/uploads/stage/stage_image/49172/optimized_large_thumb_stage.jpg",
  Invite = "https://discord.gg/Y7XMTANz"
})
