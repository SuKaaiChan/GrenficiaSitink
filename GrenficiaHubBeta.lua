...
local Window = Fluent:CreateWindow({
    Title = config["Grenficia Hub  Premium "],
    SubTitle = config["By Sukaichan"],
    TabWidth = 160,
...
function Tween(Pos)
    ...
    if game.Players.LocalPlayer.Character.Humanoid.Sit and not _G.KillShark and not _G.KillPiranha and
        not _G.KillTerrorShark and not _G.KillFishCrew then
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.AutoElite or _G.AutoFactory or _G.AutoPirates or _G.AutoBone or _G.AutoKatakuri or _G.AutoSi2 or
                _G.LevelFarm or NoCLip == true then
...
ImageButton.Image = config["Image"]
...
do
    ...
    Fluent:Notify({
        Title = config["Title"],
        Content = config["Title"] .. " Welcome Again To Script",
    ...
    local Tabs = {
        ...
        ST = Window:AddTab({
            Title = "Status and Servers",
            Icon = "bar-chart-4"
        }),
        ST = Window:AddTab({
            Title = "Devil Fruit and Raid",
            Icon = "apple"
        }),
        UR = Window:AddTab({
            Title = "Upgrate Race",
    ...
    Tabs.I:AddParagraph({
        Title = "Owner Script",
        Content = "Owner Script : " .. config["Credit"]
    })

    if not config["BirthDay"] == nil then
        Tabs.I:AddParagraph({
            Title = "My BirthDay",
            Content = config["BirthDay"]
        })
    end

    Tabs.I:AddParagraph({
        Title = "I Doesn't Skid",
        Content = "I Doesn't Skid any Source!"
    })

    local DC = Tabs.I:AddSection("Upgrated")

    Tabs.I:AddParagraph({
        Title = "Update Auto Farm, Bring Mob, FastAttack, ...",
        Content = "update."
    })

    if not config["Discord"] == nil then
        Tabs.I:AddButton({
    ...
    local Battocv4 = Tabs.G:AddToggle("Battocv4", {
        Title = "Auto Turn V4",
        Default = false
    })
    ...
    local FarmToggle = Tabs.G:AddToggle("FarmToggle", {
        Title = "Auto Farm",
        Default = false
    })
            ...
            if _G.LevelFarm then
                pcall(function()
                    ...
                    if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle
                                           .Title.Text, NameMob) or
                        not game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                        if BypassTP then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameMob.Position).Magnitude >
                                2000 then
                                Taixiu(CFrameMob)
                            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameMob.Position).Magnitude <
                                2000 then
                                Tween(CFrameQuest)
                            end
                        else
                    ...
                    elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle
                                           .Title.Text, NameMob) or
                        game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible then
                        for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and
                                v.Humanoid.Health > 0 and v.Name == Mob then
                                repeat
                                    task.wait()
                                    EnableBuso()
                                    EquipTool(SelectWP)
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild(Mob) then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild(Mob).HumanoidRootPart.CFrame *
                                      CFrame.new(2, 20, 2))
                        end
                    end
                end)
    ...
    local AutoKatakuriToggle = Tabs.G:AddToggle("AutoKatakuriToggle", {
        Title = "Auto Katakuri",
        Default = false
    })
    ...
    spawn(function()
        while wait() do
            if _G.AutoKatakuri then
                pcall(function()
                    local spawnerData = game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
                        "CakePrinceSpawner")
                        ...
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Cake Prince" or v.Name == "Dough King" then
                                if v.Humanoid.Health > 0 and
                                    (v:FindFirstChild("HumanoidRootPart") or v.Parent or _G.AutoKatakuri) then
                                    repeat
                                        wait()
                                        EnableBuso()
                                        EquipTool(SelectWP)
                                    ...
                                    until v.Humanoid.Health <= 0 or not v.Parent or
                                        ...
                                        game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency == 1
                                end
                            end
                        end
                    else
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince").HumanoidRootPart
                                      .CFrame * CFrame.new(20, -50, 20))
                        elseif game:GetService("ReplicatedStorage"):FindFirstChild("Dough King") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Dough King").HumanoidRootPart
                                      .CFrame * CFrame.new(20, -50, 20))
                        else
                            if CountMob == 0 then
                            end
                                ...
                                if game:GetService("Workspace").Enemies:FindFirstChild("Cookie Crafter") or
                                    ...
                                    if BypassTP then
                                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
                                            PosCake.Position).Magnitude > 2000 then
                                            Taixiu(PosCake)
                                    ...
                                    if game:GetService("ReplicatedStorage"):FindFirstChild("Cookie Crafter") then
                                        ...
                                        if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Guard") then
                                            ...
                                            if game:GetService("ReplicatedStorage"):FindFirstChild("Baking Staff") then
                                                Tween(game:GetService("ReplicatedStorage")
    ...
    local AutoBoneToggle = Tabs.G:AddToggle("AutoBoneToggle", {
        Title = "Auto Bone",
        Default = false
    })
                        ...
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and
                                ...
                                if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or
                                    ...
                                    if v.Humanoid.Health > 0 and
                                        (v:FindFirstChild("HumanoidRootPart") or v.Parent or _G.AutoBone) then
                                        repeat
                                            task.wait()
                                            EnableBuso()
                                            EquipTool(SelectWP)
                                            ...
                                            game:GetService 'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until v.Humanoid.Health <= 0 or not v.Parent or
                                            not v:FindFirstChild("HumanoidRootPart") or not _G.AutoBone
                                    end
                                end
                            end
                        end
    ...
    local AutoFactory = Tabs.G:AddToggle("AutoFactory", {
        Title = "Auto Factory",
        Default = false
    })
    ...
    local AutoElite = Tabs.G:AddToggle("AutoElite", {
        Title = "Auto Elite",
        Default = false
    })
                                    ...
                                    if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and
                                            ...
                                            repeat
                                                ...
                                                game:GetService 'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                            until v.Humanoid.Health <= 0 or not v.Parent or
                                                not v:FindFirstChild("HumanoidRootPart") or not _G.AutoElite
                                        end
                                    end
                                end
                            else
    ...
    local AutoPirates = Tabs.G:AddToggle("AutoPirates", {
        Title = "Auto Pirates",
        Default = false
    })
    ...
    local AutoSecondSea = Tabs.IQ:AddToggle("AutoSecondSea", {
        Title = "Auto Sea 2",
        Default = false
    })
            ...
            pcall(function()
                if _G.AutoSi2 then
                    if game.Players.LocalPlayer.Data.Level.Value >= 700 and taodangosea1 then
                        if game.Workspace.Map.Ice.Door.CanCollide == true and game.Workspace.Map.Ice.Door.Transparency ==
                            0 then
                        ...
                        elseif game.Workspace.Map.Ice.Door.CanCollide == false and
                            ...
                            if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral") then
                                for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name == "Ice Admiral" and v.Humanoid.Health > 0 and
                                        v:FindFirstChild("HumanoidRootPart") and v.Parent and _G.AutoSi2 then
                                        repeat
                                            task.wait()
                                            EnableBuso()
                                            EquipTool(SelectWP)
                                            ...
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
                                                "TravelDressrosa")
                                        until not _G.AutoSi2 or v.Humanoid.Health <= 0 or
    ...
    local BringMob = Tabs.S:AddToggle("BringMob", {
        Title = "Bring Mob",
        Default = true
    })
                ...
                pcall(function()
                    ...
                    for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if _G.LevelFarm and BringMob then
                            if v.Name == Mob and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and
                                v.Parent and
                        ...
                        if _G.AutoKatakuri and BringKatakuriMob then
                            if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or
                                v.Name == "Head Baker") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health >
                                0 and v.Parent and
                                (v.HumanoidRootPart.Position -
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                                v.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                        ...
                        if _G.AutoBone and StartCheckBone then
                            if (v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or
                                v.Name == "Posessed Mummy") and v:FindFirstChild("HumanoidRootPart") and
                                v.Humanoid.Health > 0 and v.Parent and
                                (v.HumanoidRootPart.Position -
                                    game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                                v.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
    ...
    local AutoBuso = Tabs.S:AddToggle("AutoBuso", {
        Title = "Auto Buso",
        Default = true
    })
    ...
    local BypassTeleport = Tabs.S:AddToggle("BypassTeleport", {
