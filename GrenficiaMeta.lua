...
local games = {
[game.PlaceId] = {
    Title = "GrenficiaHub Script Free By sukaichan",
    Icons = "rbxassetid://5004759498",
    Welcome = function()
            return tostring(
            " "
                ..

                        Gamename.. "!" .. " Grenficia Hub]"  .."\n Loadded Succesfully dev script by sukaichan"
            )
    end
}
}
if games[game.PlaceId] then	
if games[game.PlaceId].Title == "Bf" then
...
game.StarterGui:SetCore("SendNotification", {
    Icon = "rbxassetid://5004759498";
    Title = "GrenficiaHub hub", 
